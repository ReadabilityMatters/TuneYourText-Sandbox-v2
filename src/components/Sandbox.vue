...
<!-- 
 ...
 -->
      ...
      <button type="button" id="reset-settings" class="reset_bg" @click="resetToDefaults(true)">Reset all</button>
      <hr class="hr_yellow" >
      <a href="https://readabilitymatters.org/register" class="montserrat">
      <div class="div_bg">
      <img src="../assets/images/rm-white.png" class="reset_img_padding"/>
      </div>
      <button type="button" id="reset-settings" class="reset_button_bg">Connect with Us</button>
      </a>
    </div>
